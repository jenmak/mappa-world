...
const HappinessHeader = ({ actions, isGlobeVisible }: IHappinessHeaderProps) => (
  <div className={isGlobeVisible?'fadeOut': 'fadeIn'}>
    ...
    <div className="px-4 py-12 sm:p-24 flex flex-col justify-center w-full sm:h-screen sm:fixed z-50 cursor-pointer"
      ...
      <div>
        <p className="text-white py-5 sm:w-2/3">The following is a visualization of world happiness based off of data from the Gallup World Poll for the <a className="underline text-cyan" rel="noopener noreferrer" target="_blank" href="https://worldhappiness.report/">World Happiness Report</a>. Citizens were asked a series of questions related to how happy they percieve themselves to be, focusing on factors such as government corruption, social support and freedom of choice.</p>
